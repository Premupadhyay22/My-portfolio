...
const NavBar = () => {
  ...
  return (
    ...
    <div>
        <h1 className="text-5xl font-signature ml-2">Prem</h1>
    </div>
    ...
    <ul className="hidden md:flex">
        ...
        {links.map(({id, link}) => (
            <li 
            key={id} className="px-4 cursor-pointer capitalize font-medium text-grey-500 hover:scale-105 duration-200">
